...
public class ControlPanel extends JPanel implements ActionListener {
    ...
    public void CreateComponentsThatWillBeSwapped() {
        ...
        opt.mascotButton.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (obj == opt.studentButton) {
            ...
            mm.isMascotSelected = false;
            mm.isProfessorSelected = false;
            System.out.println("Student is " + opt.isStudentSelected);
            validate();
            repaint();
        ...
        if (obj == opt.professorButton) {
            ...
            mm.isStudentSelected = false;
            mm.isMascotSelected = false;
            System.out.println("Professor is " + opt.isProfessorSelected);
            validate();
            repaint();
            
        }
        if (obj == opt.mascotButton) {
            opt.isMascotSelected = true;
            opt.isProfessorSelected = false;
            opt.isStudentSelected = false;
            mm.isMascotSelected = true;
            mm.isProfessorSelected = false;
            mm.isStudentSelected = false;
            System.out.println("Mascot is " + opt.isMascotSelected);
            validate();
            repaint();
