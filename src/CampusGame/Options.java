...
public class Options extends JPanel{
    ...
    boolean isStudentSelected, isMascotSelected, isProfessorSelected, isTheme1Selected = false, isTheme2Selected = false, isTheme3Selected = false;
    JButton optReturn, studentButton, mascotButton, professorButton, them1, them2, them3;
    ...
    public Options(){
        ...
        mascotButton = new JButton("Nittany Lion");
        professorButton = new JButton("Professor");
        
        them1= new JButton("Penn State");
        ...
        mascotButton.setBounds(new Rectangle(150,225,125,25));
    ...
    private void doDrawing(Graphics g){
        ...
        //********Draw default background with default char (student)**********
            ...
            add(mascotIbar);
            add(mascotMSbar);
        //Paint Theme 1 background, then paint all text on top of it.
        ...
        //Paint Theme 2 background, then paint all text on top of it.
        ...
        //Paint Theme 3 background, then paint all text on top of it
        if (isTheme3Selected == true)
        {
        ...
        //Change icon if student is selected.  
        ...
        //Change icon if mascot is selected.  
            if (isMascotSelected == true)
            {
        ...
        //Change icon if professor is selected.  
           if (isProfessorSelected == true)
            {
